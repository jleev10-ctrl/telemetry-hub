// Generic driver image box — renders any driver's hero portrait, scenes, voice caption.
// Renamed from MikeImageBox for clarity now that all buckets share it.
import { Radio, RefreshCw, Zap, ChevronRight } from "lucide-react";
import { cn } from "@/lib/utils";
import { Button } from "@/components/ui/button";

interface DriverImageBoxProps {
  name: string;
  league: string;
  tag: string;
...
const statusColor: Record<DriverImageBoxProps["status"], string> = {
